...
public class MainActivity_depricated extends AppCompatActivity implements DriveController.ConnectionCallback
{
    private static final String TAG = "MainActivity_depricated";
